    ...
    function initForm(formId, successId) {
        ...
        if (fields.education.el) {
            fields.education.el.addEventListener('change', () => {
                if (!fields.education.el.value) showError(fields.education, 'Vui lòng chọn trình độ học vấn.');
        ...
        if (fields.english.el) {
            fields.english.el.addEventListener('change', () => {
                if (!fields.english.el.value) showError(fields.english, 'Vui lòng chọn trình độ Tiếng Anh.');
        ...
        form.addEventListener('submit', function (e) {
            ...
            if (!eduVal) {
                showError(fields.education, 'Vui lòng chọn trình độ học vấn.');
                valid = false;
            } else clearError(fields.education);

            const engVal = fields.english.el ? fields.english.el.value : '';
            if (!engVal) {
                showError(fields.english, 'Vui lòng chọn trình độ Tiếng Anh.');
                valid = false;
            } else clearError(fields.english);
