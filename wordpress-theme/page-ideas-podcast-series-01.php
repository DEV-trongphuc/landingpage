    ...
    <header class="ideas_header" id="site-header">
        <div class="container header-inner">
            ...
            <div class="header-actions">
                <button type="button" class="btn btn-primary" onclick="showform('podcast_header')">
    ...
    <div class="mobile-menu" id="mobile-menu" aria-hidden="true">
        ...
        <div class="mobile-menu-body">
            ...
            <button type="button" class="btn btn-primary btn-full" style="margin-top: 24px;"
                onclick="closeMenu(); showform('podcast_mobile_header')">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (hamburger && mobileMenu && mobileOverlay) {
                ...
                // Make closeMenu public/available globally for the popup click handler
