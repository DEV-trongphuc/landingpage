...
<body <?php body_class(); ?>>
    ...
    <header class="ideas_header" id="site-header">
        <div class="container header-inner">
            ...
            <div class="header-actions">
                <button type="button" class="btn btn-primary" onclick="showform('talk_header')">
                    <i class="fa-solid fa-headset"></i> <span>Đăng ký</span>
                </button>
                <button type="button" class="hamburger-btn" id="hamburger" aria-label="Mở menu di động">
    ...
    <div class="mobile-menu" id="mobile-menu" aria-hidden="true">
        <div class="mobile-menu-header">
            <img src="https://ideas.edu.vn/wp-content/uploads/2026/06/Logo_IDEAS_Slg.webp" alt="IDEAS Logo" width="50"
                height="50">
            <button type="button" class="mobile-menu-close" id="mobile-menu-close" aria-label="Đóng menu">✕</button>
        </div>
        <div class="mobile-menu-body">
            <div class="mobile-nav-item">
                <button type="button" class="mobile-dropdown-toggle" aria-expanded="false">Giới thiệu <i
                        class="fa-solid fa-angle-down"></i></button>
                <div class="mobile-dropdown-content">
                    <a href="/he-thong-ho-tro-hoc-tap-lms-ideas"><i class="fa-solid fa-layer-group"></i> Hệ thống LMS</a>
            ...
            <div class="mobile-nav-item">
                <button type="button" class="mobile-dropdown-toggle" aria-expanded="false">Chương trình <i
                        class="fa-solid fa-angle-down"></i></button>
                <div class="mobile-dropdown-content">
                    ...
                    <a href="/mscai"><i class="fa-solid fa-graduation-cap"></i> Master AI (MSc AI)</a>
                    <a href="/mbainai"><i class="fa-solid fa-graduation-cap"></i> MBA in AI</a>
                    <a href="/bba"><i class="fa-solid fa-user-graduate"></i> Top-up BBA</a>
                    <a href="/fullbba"><i class="fa-solid fa-user-graduate"></i> Full BBA</a>
                    <a href="/dual-dba"><i class="fa-solid fa-award"></i> Dual DBA</a>
                </div>
            </div>
            <div class="mobile-nav-item">
                <button type="button" class="mobile-dropdown-toggle" aria-expanded="false">Chính sách <i
                        class="fa-solid fa-angle-down"></i></button>
                <div class="mobile-dropdown-content">
            ...
            <div class="mobile-nav-item">
                <button type="button" class="mobile-dropdown-toggle" aria-expanded="false">Bản tin <i
                        class="fa-solid fa-angle-down"></i></button>
                <div class="mobile-dropdown-content">
            ...
            <button type="button" class="btn btn-primary btn-full" style="margin-top: 24px;"
                onclick="closeMenu(); showform('talk_mobile_header')">
        ...
        <div class="reg-modal-container" data-lenis-prevent>
            ...
            <div class="reg-modal-content">
                <header class="modal-form-header">
                    ...
                    <h3>Đăng ký tham gia <br><span class="gradient-text">IDEAS Talk &amp; AI</span></h3>
                    <p>Điền thông tin bên dưới, chuyên viên tư vấn sẽ liên hệ hướng dẫn lịch học và nhận link Zoom.</p>
                </header>
                ...
                <form class="cta-form modal-form" id="modal-cta-form" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="modal-message" name="message" placeholder="Ví dụ: Tôi muốn hỏi về lịch tổ chức các buổi Workshop tiếp theo..." rows="3"></textarea>
                    </div>
                ...
                <div class="modal-form-success" id="modal-form-success">
                    ...
                    <p>Cảm ơn bạn đã quan tâm. Chuyên viên tư vấn của IDEAS sẽ sớm liên hệ với bạn để xác nhận lịch học Zoom.</p>
                    ...
                    <div class="bk-field">
                        ...
                        <div class="bk-program-grid" id="bk-program-grid">
                            <label class="bk-program-card">
                                <input type="radio" name="bk-program" value="Chuyên đề IDEAS Talk" checked />
                                <div class="bk-program-inner">
                                    <div class="bk-program-icon">💻</div>
                                    <div class="bk-program-name">Webinar IDEAS Talk</div>
                                    <div class="bk-program-desc">Nhận link Zoom và tài liệu AI</div>
                                </div>
                            </label>
                            <label class="bk-program-card">
    ...
    <script>
        function showform(ctaSource = 'talk_cta') {
