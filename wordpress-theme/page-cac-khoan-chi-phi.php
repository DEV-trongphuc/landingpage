...
<body <?php body_class(); ?>>
        ...
        <div class="container header-inner">
            ...
            <nav class="header-nav">
                ...
                <div style="display:flex;align-items:center;gap:8px;">
                    <a class="nav-cta" onclick="showform('cac_khoan_chi_phi_header')">Nhận tư vấn</a>
                </div>
            </nav>
    ...
    <div class="mobile-menu" id="mobile-menu" aria-hidden="true" data-lenis-prevent>
        ...
        <div style="padding: 20px;">
            <a class="nav-cta" style="display: block; text-align: center;" onclick="showform('cac_khoan_chi_phi_header_mb')">Nhận tư vấn</a>
        </div>
    </div>
