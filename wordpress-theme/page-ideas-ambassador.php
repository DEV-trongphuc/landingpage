...
<body <?php body_class(); ?>>
    ...
    <div class="mobile-menu" id="mobile-menu" aria-hidden="true" data-lenis-prevent>
        ...
        <div style="padding: 20px;">
            <a href="/dat-lich" class="nav-cta" style="display: block; text-align: center;">Nhận tư vấn</a>
        </div>
    </div>
        ...
        <div class="reg-modal-container" data-lenis-prevent>
            ...
            <div class="reg-modal-content">
                <header class="modal-form-header">
                    ...
                    <h3>Khởi đầu hành trình <br><span class="gradient-text">Đại sứ IDEAS</span></h3>
                ...
                <form class="cta-form modal-form" id="modal-cta-form" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="modal-message" name="message" placeholder="Ví dụ: Tôi muốn tìm hiểu chi tiết hơn về cách tích lũy tín chỉ học thuật..." rows="3"></textarea>
                    </div>
                    ...
                    <div class="bk-field">
                        ...
                        <div class="bk-program-grid" id="bk-program-grid">
                            <label class="bk-program-card">
                                <input type="radio" name="bk-program" value="Chính sách Ambassador" checked />
                                <div class="bk-program-inner">
                                    <div class="bk-program-icon">🎓</div>
                                    <div class="bk-program-name">Đại sứ thương hiệu</div>
                                    <div class="bk-program-desc">Tìm hiểu chính sách Ambassador</div>
                                </div>
                            </label>
                            <label class="bk-program-card">
    ...
    <script>
        function showform(ctaSource = 'ambassador_cta') {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Ambassador News Slider Dots
            const newsGrid = document.querySelector('.amb-news-grid');
            if (newsGrid) {
                const cards = newsGrid.querySelectorAll('.amb-news-card');
                if (cards.length > 0) {
                    const dotsContainer = document.createElement('div');
                    dotsContainer.className = 'slider-dots';
                    newsGrid.parentNode.insertBefore(dotsContainer, newsGrid.nextSibling);
                    ...
                    newsGrid.addEventListener('scroll', () => {
                        ...
                        const firstCard = newsGrid.querySelector('.amb-news-card');
                        if (!firstCard) return;
