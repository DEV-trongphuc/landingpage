    ...
    <div class="mobile-menu" id="mobile-menu" aria-hidden="true" data-lenis-prevent>
        ...
        <div class="mobile-dropdown">
            ...
            <div class="mobile-dropdown-menu">
                ...
                <a href="/lich-su-hinh-thanh-va-phat-trien-vien-ideas"><i class="fa-solid fa-landmark"></i> Lịch sử phát
                    triển</a>
            </div>
        </div>
        <div class="mobile-dropdown">
        ...
        <div class="mobile-dropdown">
            ...
            <div class="mobile-dropdown-menu">
                <a href="/ho-tro-tai-chinh-sacombank"><i class="fa-solid fa-circle-dollar-to-slot"></i> Trả góp học
                    phí</a>
